package com.cogenio.jhipstermyapp.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.cogenio.jhipstermyapp.service.EmailAlreadyUsedException ||
            ex instanceof com.cogenio.jhipstermyapp.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.cogenio.jhipstermyapp.service.InvalidPasswordException
